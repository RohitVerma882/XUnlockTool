...
import com.xut.Constants.UNLOCK_HMAC_KEY
import com.xut.domain.model.Auth
import com.xut.util.HttpQuery
import com.xut.util.HttpUtils
import com.xut.util.StringUtils
...
class UnlockRequest private constructor(
    ...
    companion object {
        @Throws(UnlockException::class, IOException::class)
        @JvmStatic
        private fun nonceV2(auth: Auth, host: String): String {
        ...
        @Throws(UnlockException::class, IOException::class)
        @JvmStatic
        fun userInfo(auth: Auth, host: String): String {
        ...
        @Throws(UnlockException::class, IOException::class)
        @JvmStatic
        fun deviceClear(auth: Auth, host: String, product: String): String {
        ...
        @Throws(UnlockException::class, IOException::class)
        @JvmStatic
        fun ahaUnlock(auth: Auth, host: String, product: String, token: String): String {
